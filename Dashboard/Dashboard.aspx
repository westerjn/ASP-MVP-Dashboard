...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Email_ID" DataSourceID="PSQLDataSource">
            <Columns>
        ...
        <asp:SqlDataSource ID="PSQLDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:PSQLConnectionString %>" ProviderName="<%$ ConnectionStrings:PSQLConnectionString.ProviderName %>" SelectCommand="SELECT * FROM Email;"></asp:SqlDataSource>
    </form>
</body>
</html>
